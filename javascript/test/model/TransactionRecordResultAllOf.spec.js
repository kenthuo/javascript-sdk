...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new KhIdentityVerification.TransactionRecordResultAllOf();
  });
  ...
  describe('TransactionRecordResultAllOf', function() {
    it('should create an instance of TransactionRecordResultAllOf', function() {
      ...
      //var instance = new KhIdentityVerification.TransactionRecordResultAllOf();
      //expect(instance).to.be.a(KhIdentityVerification.TransactionRecordResultAllOf);
    });
