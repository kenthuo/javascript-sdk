...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new KhIdentityVerification.DatasourceField();
  });
  ...
  describe('DatasourceField', function() {
    it('should create an instance of DatasourceField', function() {
      ...
      //var instance = new KhIdentityVerification.DatasourceField();
      //expect(instance).to.be.a(KhIdentityVerification.DatasourceField);
    });
