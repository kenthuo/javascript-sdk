...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new KhIdentityVerification.DriverLicence();
  });
  ...
  describe('DriverLicence', function() {
    it('should create an instance of DriverLicence', function() {
      ...
      //var instance = new KhIdentityVerification.DriverLicence();
      //expect(instance).to.be.a(KhIdentityVerification.DriverLicence);
    });
