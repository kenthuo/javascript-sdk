...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new KhIdentityVerification.ServiceError();
  });
  ...
  describe('ServiceError', function() {
    it('should create an instance of ServiceError', function() {
      ...
      //var instance = new KhIdentityVerification.ServiceError();
      //expect(instance).to.be.a(KhIdentityVerification.ServiceError);
    });
