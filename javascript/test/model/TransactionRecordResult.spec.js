...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new KhIdentityVerification.TransactionRecordResult();
  });
  ...
  describe('TransactionRecordResult', function() {
    it('should create an instance of TransactionRecordResult', function() {
      ...
      //var instance = new KhIdentityVerification.TransactionRecordResult();
      //expect(instance).to.be.a(KhIdentityVerification.TransactionRecordResult);
    });
