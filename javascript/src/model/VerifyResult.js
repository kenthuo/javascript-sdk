...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Record', 'model/ServiceError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Record'), require('./ServiceError'));
  } else {
    // Browser globals (root is window)
    if (!root.KhIdentityVerification) {
      root.KhIdentityVerification = {};
    }
    root.KhIdentityVerification.VerifyResult = factory(root.KhIdentityVerification.ApiClient, root.KhIdentityVerification.Record, root.KhIdentityVerification.ServiceError);
  }
}(this, function(ApiClient, Record, ServiceError) {
  'use strict';
