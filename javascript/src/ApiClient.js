...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KhIdentityVerification.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://gateway.trulioo.com/trial
     */
    this.basePath = 'https://gateway.trulioo.com/trial'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'ApiKeyAuth': {type: 'apiKey', 'in': 'header', name: 'x-trulioo-api-key'}
    };
    /**
